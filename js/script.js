...
function mapSetup() {
	...
	var placeLayer = {
		...
		sublayers: [{
			...
			interactivity: ['trip_id', 'string_date', config.column_names.date, 'clean_date', 'ride_quality_score', 'ride_quality_round', config.column_names.img_location, 'cartodb_id']
		}]
	};
